...
$(document).ready(function() {
    ...
    var alert_preview = $("#demo-preview-alert").children(".alert"),
        ...
        alert_content = [{
                ...
                type: '<div class="media-left"><span class="icon-wrap icon-wrap-xs icon-circle alert-icon"><i class="demo-psi-gear-2 icon-2x"></i></span></div><div class="media-body"><h4 class="alert-title">Server Load Limited</h4><p class="alert-message">Database server has reached its daily capicity</p></div>'
            }, {
