...
$(document).ready(function () {
    ...
    if (demoSet.length) {
        ...
        var demoSet = $('#demo-set'), demoSetBody = $('#demo-set-body'), demoSetBtn = $('#demo-set-btn');
        $('html').on('click', function(e){
            if (demoSet.hasClass('in')){
                if (!$(e.target).closest('#demo-set-body').length) {
        ...
        demoSetBtn.on('click', function(){
            ...
            return false;
        }).one('click', InitializeSettingWindow);
